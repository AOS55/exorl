...
def parse_args():
    ...
    parser.add_argument('--num_expl_steps', type=int, default=100000)
...
def add_env_options(params):
    ...
    if params['env'] == 'spb':
        ...
        params['buffer_size'] = 35000
        params['data_dirs'] = [
            'SimpleVelocityBot', 'SimpleVelocityBotConstraintTeacher'
        ]
        params['data_counts'] = [
            50,
            50
        ...
        params['frame_stack'] = 1
    elif params['env'] == 'drone':
        params['buffer_size'] = 35000
        params['data_dirs'] = [
            'DroneGate',
            'DroneGateConstraints'
        ]
        params['data_counts'] = [
            50,
            50
