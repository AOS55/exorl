    ...
    def act(self, obs):
        ...
        while itr < self.max_iters:
            if itr == 0:
                ...
                self.mean, self.std = elites.mean(0), elites.std(0)  # if there is only one constraint satisfying value can't get std
            ...
            if itr < self.max_iters - 1:
                ...
                # print(f'emb: {emb}')
                # print(f'action_samples: {action_samples}')
                # print(f'sample_mean: {self.mean}')
