...
class Workspace:
    def __init__(self, cfg):
        ...
        self.replay_storage = ReplayBufferStorage(data_specs, meta_specs, self.work_dir / 'buffer')
    ...
    def sample(self):
        ...
        os.makedirs(os.path.join(self.work_dir, 'buffer'), exist_ok=True)
    ...
    @hydra.main(config_path="configs/.", config_name="sac_sampling")
    def main(cfg):
        from sac_sampling import Workspace as W
        workspace = W(cfg)
        workspace.sample()
